# train_wavenet_z24_file_70_30_amp_scale_only.py
import os
...
RUN_GROUP = "amp_scale_only"  # results saved to ./History/amp_scale_only/v1, v2, ...
...
# ============================================================
# Amplitude Scaling Augmentation (TRAIN ONLY)
# ============================================================
...
def train_wavenet_file_split_70_30(
    ...
    print(f"[AUG] Amplitude scaling only: p={scaling_p}, range=[{scale_min}, {scale_max}] (TRAIN only)")
    ...
    for epoch in range(1, epochs + 1):
        ...
        for xb, yb in train_loader:
            ...
            # TRAIN augmentation: amplitude scaling ONLY
...
if __name__ == "__main__":
    train_wavenet_file_split_70_30(
        ...
        # amplitude scaling only (Z24-friendly)
        scaling_p=0.7,
        scale_min=0.90,
        scale_max=1.10,
    )
